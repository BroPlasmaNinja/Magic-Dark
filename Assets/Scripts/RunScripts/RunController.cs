...
public sealed class RunController : MonoBehaviour
{
    ...
    public float spawnRadius = 10f; // Ðàäèóñ, â êîòîðîì áóäóò ñïàâíèòüñÿ âðàãè
    public float minSpawnRadius = 5f; // Ìèíèìàëüíûé ðàäèóñ, ÷òîáû âðàãè íå ñïàâíèëèñü ñëèøêîì áëèçêî ê èãðîêó
    ...
    IEnumerator SpawnerWaves(Wave currentWave)
    {
        for (int i = 0; i < currentWave.countRepeat.Count; i++)
        {
            for (int j = 0; j < currentWave.EnemiesCount[i]; j++)
            {
                ...
                {
                    // Ñîçäàíèå âðàãà â ñëó÷àéíîé òî÷êå â ðàäèóñå îò èãðîêà
    ...
    // Ìåòîä äëÿ ïîëó÷åíèÿ ñëó÷àéíîé ïîçèöèè ñïàâíà â ðàäèóñå îò èãðîêà
